...
public class OEConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> LADIA_ORES = CONFIGURED_FEATURE.register("laida_ore", ()-> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(WORLD_LADIA_ORE.get(), 1)));
